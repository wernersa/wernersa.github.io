<template>
  <Head>
    <Title>About - Werner Sævland</Title>
    <Meta name="description" content="About the Singapore-based Norwegian psychologist, Werner Sævland" />
  </Head>

  <div class="prose lg:prose-lg prose-slate dark:prose-invert mx-auto">
    <h2>Professional approach and experience</h2>

    <p class="lead">
      I consider myself to be a person who is open-minded, curious, and engaging. I continuously strive to improve and become a better therapist.
    </p>
    ...
    <p>
      You can read more about me at <a href="https://theotherclinic.sg/werner-saevland/">theotherclinic.sg</a>
    </p>
